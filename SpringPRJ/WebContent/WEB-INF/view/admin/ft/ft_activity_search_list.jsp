...
<div class="container" style="background-color:rgba(255,255,255,0.9);  padding-top:15px; padding-bottom:30px;  padding-left:30px; padding-right:30px;">
	<div style="width:100%;">
		<div style="float:left;">
			<h2>푸드트럭 정지/탈퇴 검색리스트</h2>
		</div>
		<div style="float:right; margin-top:20px;">
			<input type="button" class="btn btn-default" value="뒤로가기" onclick="location.href='<%=request.getContextPath()%>/admin/ft/ft_activity_list.do'">
		</div>
	</div>
    <div style="border-bottom:1px solid #444444; margin-top:15px; clear:both;"></div>
	<div style="margin-top:15px; margin-bottom:25px;">
        <form class="form-inline" action="<%=request.getContextPath()%>/admin/ft/ft_activity_search_list.do" method="GET"> 
	...
	<div id="table_container">
		<%@ include file="ft_activity_search_table.jsp" %>
