...
<h3>메뉴상세정보</h3>
    <div style="border-bottom:1px solid #444444; margin-top:15px;"></div>
			...
			<div style="padding:10px; width:100%;">
				<div class="row">
						<div class="col-sm-4" style="border:1px solid #cccccc; height: 240px;">
			...
			<div class="row" style="margin-top:10px; text-align:center;">
				<div class="col-sm-6" style="text-align:left;">
					<button type="button" class="btn btn-default" style="" onClick="location.href='<%=request.getContextPath()%>/seller/ft/ft_info.do?ft_seq=<%=ftDTO2.getFt_seq()%>'">목록</button>
				...
				<div class="col-sm-6" style="text-align:right;">					
					<button type="button" class="btn btn-danger"  onClick="location.href='<%=request.getContextPath()%>/seller/ft/ft_menu_delete.do?ft_seq=<%=ftDTO2.getFt_seq()%>&menu_seq=<%=menuDTO.getMenu_seq()%>'">삭제</button>
				</div>
			</div>
